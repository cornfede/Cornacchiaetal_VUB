...
mean(var3$avg_price, na.rm = TRUE)
mean(var3$avg_land_square_feet, na.rm = TRUE)
mean(var3$avg_gross_square_feet, na.rm = TRUE)
mean(var3$avg_age, na.rm = TRUE)
mean(var3$avg_sch_dist, na.rm = TRUE)
mean(var3$avg_wt_dist, na.rm = TRUE)
mean(var3$avg_cbd_dist, na.rm = TRUE)
mean(var3$mean_ndvi, na.rm = TRUE)
mean(var3$S, na.rm = TRUE)
mean(var3$H, na.rm = TRUE)
mean(var3$hh_med_inc, na.rm = TRUE)
mean(var3$ue_rt, na.rm = TRUE)
mean(var3$pct_bk_ppl, na.rm = TRUE)
mean(var3$pv_rt, na.rm = TRUE)
mean(var3$pop_den, na.rm = TRUE)
mean(var3$avg_tt, na.rm = TRUE)
mean(var3$crime_rt, na.rm = TRUE)
sd(var3$avg_price, na.rm = TRUE)
sd(var3$avg_land_square_feet, na.rm = TRUE)
sd(var3$avg_gross_square_feet, na.rm = TRUE)
sd(var3$avg_age, na.rm = TRUE)
sd(var3$avg_sch_dist, na.rm = TRUE)
sd(var3$avg_wt_dist, na.rm = TRUE)
sd(var3$avg_cbd_dist, na.rm = TRUE)
sd(var3$mean_ndvi, na.rm = TRUE)
sd(var3$S, na.rm = TRUE)
sd(var3$H, na.rm = TRUE)
sd(var3$hh_med_inc, na.rm = TRUE)
sd(var3$ue_rt, na.rm = TRUE)
sd(var3$pct_bk_ppl, na.rm = TRUE)
sd(var3$pv_rt, na.rm = TRUE)
sd(var3$pop_den, na.rm = TRUE)
sd(var3$avg_tt, na.rm = TRUE)
sd(var3$crime_rt, na.rm = TRUE)

# Producing scatterplots

plot(var3$avg_land_square_feet, var3$avg_price, main = "Average Land Square Feet - Average Price", las = 1)
plot(var3$avg_gross_square_feet, var3$avg_price, main = "Average Gross Square Feet - Average Price", las = 1)
plot(var3$avg_age, var3$avg_price, main = "Average Age Property - Average Price", las = 1)
plot(var3$avg_sch_dist, var3$avg_price, main = "Average School Proximity - Average Price", las = 1)
plot(var3$avg_wt_dist, var3$avg_price, main = "Average Water Body Proximity - Average Price", las = 1)
plot(var3$avg_cbd_dist, var3$avg_price, main = "Average Central Business District Proximity - Average Price", las = 1)
plot(var3$mean_ndvi, var3$avg_price, main = "Mean NDVI - Average Price", las = 1)
plot(var3$S, var3$avg_price, main = "S - Average Price", las = 1)
plot(var3$H, var3$avg_price, main = "H - Average Price", las = 1)
plot(var3$hh_med_inc, var3$avg_price, main = "Household Median Income - Average Price", las = 1)
plot(var3$ue_rt, var3$avg_price, main = "Unemployment Rate - Average Price", las = 1)
plot(var3$pct_bk_ppl, var3$avg_price, main = "Percentage Black People - Average Price", las = 1)
plot(var3$pv_rt, var3$avg_price, main = "Poverty Rate - Average Price", las = 1)
plot(var3$pop_den, var3$avg_price, main = "Population Density - Average Price", las = 1)
plot(var3$avg_tt, var3$avg_price, main = "Average Commuting Time (min) - Average Price", las = 1)
plot(var3$crime_rt, var3$avg_price, main = "Crime Rate - Average Price", las = 1)

# Running Pearson Correlation Coefficients 

cor.test(var3$avg_price, var3$avg_land_square_feet)
cor.test(var3$avg_price, var3$avg_gross_square_feet)
cor.test(var3$avg_price, var3$avg_age)
cor.test(var3$avg_price, var3$avg_sch_dist)
cor.test(var3$avg_price, var3$avg_wt_dist)
cor.test(var3$avg_price, var3$avg_cbd_dist)
cor.test(var3$avg_price, var3$mean_ndvi)
cor.test(var3$avg_price, var3$S)
cor.test(var3$avg_price, var3$H)
cor.test(var3$avg_price, var3$hh_med_inc)
cor.test(var3$avg_price, var3$ue_rt)
cor.test(var3$avg_price, var3$pct_bk_ppl)
cor.test(var3$avg_price, var3$pv_rt)
cor.test(var3$avg_price, var3$pop_den)
cor.test(var3$avg_price, var3$avg_tt)
cor.test(var3$avg_price, var3$crime_rt)
...
plot(train_sample$hh_med_inc, train_sample$avg_price, main = "Household Median Income - Price", las = 1)
plot(train_sample$hh_med_inc, log(train_sample$avg_price), main = "Household Median Income - Log Price", las = 1)
plot(log(train_sample$hh_med_inc), log(train_sample$avg_price), main = "Log Household Median Income - Log Price", las = 1)
plot(sqrt(train_sample$hh_med_inc), log(train_sample$avg_price), main = "SQRT Household Median Income - Log Price", las = 1)

# Pearson Correlation Coefficient

cor.test(train_sample$avg_price, train_sample$hh_med_inc)
cor.test(log(train_sample$avg_price), train_sample$hh_med_inc)
cor.test(log(train_sample$avg_price), log(train_sample$hh_med_inc))
cor.test(log(train_sample$avg_price), sqrt(train_sample$hh_med_inc))

# Unemployment Rate

plot(train_sample$ue_rt, train_sample$avg_price, main = "Unemployment Rate - Price", las = 1)
plot(train_sample$ue_rt, log(train_sample$avg_price), main = "Unemployment Rate - Log Price", las = 1)
plot(log(train_sample$ue_rt), log(train_sample$avg_price), main = "Log Unemployment Rate - Log Price", las = 1)
plot(sqrt(train_sample$ue_rt), log(train_sample$avg_price), main = "SQRT Unemployment Rate - Log Price", las = 1)

# Pearson Correlation Coefficient

cor.test(train_sample$avg_price, train_sample$ue_rt)
cor.test(log(train_sample$avg_price), train_sample$ue_rt)
cor.test(log(train_sample$avg_price), log(train_sample$ue_rt + 1))
cor.test(log(train_sample$avg_price), sqrt(train_sample$ue_rt))

# Percentage Black People
...
cor.test(log(train_sample$avg_price), log(train_sample$pct_bk_ppl + 1))
...
Model1 <- lm(formula = avg_price ~ avg_land_square_feet + avg_gross_square_feet + 
               avg_age + avg_sch_dist + avg_wt_dist + avg_cbd_dist + mean_ndvi + 
               H + hh_med_inc + ue_rt + pct_bk_ppl + crime_rt, data = train_sample)
summary(Model1)
...
Model2 <- lm(formula = log(avg_price) ~ avg_land_square_feet + avg_gross_square_feet + 
               avg_sch_dist + avg_wt_dist + avg_cbd_dist + mean_ndvi + H + 
               ue_rt + pct_bk_ppl + pv_rt + crime_rt, data = train_sample)
summary(Model2)
...
FitAll_1 <- lm(log(avg_price) ~ log(avg_land_square_feet) + log(avg_gross_square_feet) + 
                 ...
                 log(pct_bk_ppl+1) + log(pv_rt) + log(pop_den) + log(avg_tt) + log(crime_rt), 
               data = train_sample)
...
Model4 <- lm(formula = log(avg_price) ~ avg_land_square_feet + avg_gross_square_feet + 
               I(avg_gross_square_feet^2) + log(avg_sch_dist) + log(avg_wt_dist + 
                                                                      1) + log(avg_cbd_dist) + log(mean_ndvi) + log(H + 1) + hh_med_inc + 
               ue_rt + pct_bk_ppl + crime_rt, data = train_sample)
summary(Model4)
...
FitAll_3 <- lm(log(avg_price) ~ avg_land_square_feet + log(avg_land_square_feet) + avg_gross_square_feet + 
                 log(avg_gross_square_feet) + I(avg_age^2) + sqrt(avg_sch_dist) + 
                 sqrt(avg_wt_dist) + sqrt(avg_cbd_dist) + log(mean_ndvi) + log(S) + log(H+1) + 
                 hh_med_inc + sqrt(ue_rt) + log(pct_bk_ppl+1) + sqrt(pv_rt) + sqrt(pop_den) + avg_tt + 
...
Model5 <- lm(formula = log(avg_price) ~ avg_land_square_feet + log(avg_gross_square_feet) + 
               I(avg_age^2) + sqrt(avg_sch_dist) + sqrt(avg_wt_dist) + sqrt(avg_cbd_dist) + 
               log(mean_ndvi) + log(H + 1) + log(pct_bk_ppl + 1) + sqrt(pv_rt) + 
               log(crime_rt), data = train_sample)
summary(Model5)

# --------------------------------------------------------------------------------------

# Trying improvements of Model4 changing some functional forms based on the previous variables plots, normal histogram, and pearson coefficients

FitAll_4 <- lm(log(avg_price) ~ avg_land_square_feet + I(avg_land_square_feet^2) + 
                 avg_gross_square_feet + avg_age + sqrt(avg_age) + 
                 log(avg_sch_dist) + log(avg_wt_dist+1) + sqrt(avg_cbd_dist) + 
                 log(mean_ndvi) + log(S) + sqrt(H) + log(hh_med_inc) + ue_rt + log(pct_bk_ppl+1) + pv_rt + 
                 log(pop_den) + avg_tt + log(crime_rt), data = train_sample)
...
Model6 <- lm(formula = log(avg_price) ~ avg_land_square_feet + avg_gross_square_feet + 
               log(avg_sch_dist) + log(avg_wt_dist + 1) + sqrt(avg_cbd_dist) + 
               log(S) + log(hh_med_inc) + log(pct_bk_ppl + 1) + log(pop_den), 
             data = train_sample)
summary(Model6)
...
train_sample$pred_price_M4 <- predict(Model4, newdata = subset(train_sample, 
                                                               select = c(avg_price, avg_land_square_feet, 
                                                                          ...
                                                                          avg_wt_dist, avg_cbd_dist, mean_ndvi, 
                                                                          H, hh_med_inc, ue_rt, pct_bk_ppl, 
                                                                          crime_rt)))
...
train_sample$pred_price_M7 <- predict(Model7, newdata = subset(train_sample, 
                                                               select = c(avg_price, avg_land_square_feet, 
                                                                          avg_gross_square_feet, avg_sch_dist, 
                                                                          avg_wt_dist, avg_cbd_dist, H, 
                                                                          hh_med_inc, pct_bk_ppl, pop_den)))
...
# 0.4356 770404.0000 735015.0000
...
# 0.4624 770404.0000 735015.0000
...
# 0.3969 765380.0000 726712.0000
...
# 0.4356 765380.0000 726712.0000
